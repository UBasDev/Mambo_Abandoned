...
func main() {
	...
	applicationBuilder := startApplicationBuild()
	...
	applicationContainer := createNewApplicationContainerModel(
	...
	err = applicationBuilder.InitZapLogger(true, applicationConfig.AppSettings.LogFilePath, zapcore.DebugLevel, map[string]any{
		"environment": environment,
	}, &applicationContainer.ZapLogger)
	if err != nil {
	...
	applicationBuilder.CreateRoutes(applicationContainer.PostgreSqlDbContext, applicationContainer.ZapLogger, &applicationContainer.Router)
